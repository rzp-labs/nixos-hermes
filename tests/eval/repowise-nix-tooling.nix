...
pkgs.runCommand "repowise-nix-tooling" { } ''
  ...
  test '${hostPkgs.llm-agents.cli-proxy-api.version}' = '7.1.50'
  test -x '${hostPkgs.llm-agents.cli-proxy-api}/bin/cli-proxy-api'
  ('${hostPkgs.llm-agents.cli-proxy-api}/bin/cli-proxy-api' --version 2>&1 || true) | grep -q -- 'CLIProxyAPI Version: 7.1.50'
